...
public class TokenProvider implements Serializable {
    ...
    private Key key; // Change to Key type

    @PostConstruct
    public void init() {
        // Generate a secure key from the signing key string
        this.key = Keys.hmacShaKeyFor(SIGNING_KEY.getBytes()); // Create a secure key
    }
